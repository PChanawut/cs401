        ...
        success: function(response){
            ...
            if(material_id != ""){
                $("#select_fav_location").click(function(){
                    ...
                    $('#location_materialseven_address').val(response.address.split(",")[0])
                    $('#location_materialseven_district').val(response.address.split(",")[1])
                    $('#location_materialseven_amphoe').val(response.address.split(",")[2])
                    $('#location_materialseven_province').val(response.address.split(",")[3])
                    $('#location_materialseven_zipcode').val(response.address.split(",")[4])
