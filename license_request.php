...
<body>
    ...
    <form id="confirm_request" method="post">
            ...
            <div class="container">
                ...
                <div class="form-row">
                    <div class="col px-md-4">
                        <form class="form-signin" id="type_license" method="post">
                            <div class="row">
                                <div id="typeone" class="col px-md-5">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="customRadioInline1" name="licensetypeone"
                                ...
                                <div id="typetwo" class="col px-md-5">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="customRadioInline2" name="licensetypetwo"
                                            class="custom-control-input">
                            ...
                            <div class="row">
                                <div id="typethree" class="col px-md-5">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="customRadioInline3" name="licensetypethree"
                                            class="custom-control-input">
                                ...
                                <div id="typefour" class="col px-md-5">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="customRadioInline4" name="licensetypefour"
                                            class="custom-control-input">
                                        <label class="custom-control-label"
                                            for="customRadioInline4">สำหรับนำเข้า-ส่งออกวัสดุนิวเคลียร์-วัสดุต้นกำลัง
                                            (ปส
                                            3ข)</label>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div id="typefive" class="col px-md-5">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="customRadioInline5" name="licensetypefive"
                                            class="custom-control-input">
                                        <label class="custom-control-label"
                                            for="customRadioInline5">สำหรับขออนุญาตพลังงานปรมาณูจากเครื่องปฏิกรณ์ปรามาณู
                                            (ปส
                                            1ง)</label>
                                    </div>
                                </div>
                                <div id="typesix" class="col px-md-5">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="customRadioInline6" name="licensetypesix"
                                            class="custom-control-input">
                                        <label class="custom-control-label"
                            ...
                            <div class="row">
                                <div id="typeseven" class="col px-md-5">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="customRadioInline7" name="licensetypeseven"
                                            class="custom-control-input">
