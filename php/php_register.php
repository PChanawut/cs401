<?php
    ...
    if(isset($_POST['person_name']) && isset($_POST['person_identification']) && isset($_POST['person_phonenumber']) && isset($_POST['person_fax']) && isset($_POST['person_birthday']) 
    && isset($_POST['person_email']) && isset($_POST['person_address']) && isset($_POST['person_district']) && isset($_POST['person_amphoe']) && isset($_POST['person_province']) 
    && isset($_POST['person_zipcode']) && isset($_POST['person_username']) && isset($_POST['person_password']) && isset($_POST['category'])){
        ...
        $sql1 = "INSERT INTO company(company_id,company_type,company_name,company_address,company_phone,company_fax,company_email,enroll_start,enroll_no,company_status)
                VALUES (NULL,'$category','$person_name','$person_address','$person_phonenumber','$person_fax','$person_email','$person_birthday','$person_identification','wait')"; 
