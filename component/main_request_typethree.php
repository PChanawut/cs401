            ...
            <div class="modal-body">
                <table class="table">
                    ...
                    <?php
                            ...
                            $sql = "SELECT license.license_id, license.place_id, materiallocation.material_address, materiallocation.material_phone, materiallocation.material_email, materiallocation.fav_location, materiallocation.type_location_material, materiallocation.material_id, materiallocation.company_id
